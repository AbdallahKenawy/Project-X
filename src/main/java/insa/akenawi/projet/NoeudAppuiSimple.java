...
public class NoeudAppuiSimple extends NoeudAppui
{
    ...
    {
        return "Noeud Appui Simple: id: "+this.getId()+", coordonnees: ("+this.getPx()+","+this.getPy()+"), Force agissante:"+this.getForce().toString();
    }
    ...
    public void dessine(GraphicsContext outil)  //Les Noeud Appui Doubles sont dessines en Bleu Fonce
    {
      outil.setFill(Color.TEAL);
    ...
    public void sauvegarde(Writer out) throws IOException {
         out.append("NoeudAS;"+this.getId()+";"+this.getPx()+";"+this.getPy()+";"+this.getForce().toString()+"\n");
    }
}
